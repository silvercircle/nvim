...
local black       = {'#202030', 235, 'black'}
local gray        = {'#808080', 244, 'gray'}
local gray_dark   = {'#353535', 236, 'darkgrey'}
local gray_darker = {'#505050', 239, 'gray'}
local gutter      = {'#181a26', 240, 'gutter'}   -- #282A36
local sign        = {'#141822', 244, 'sign'}
local foldbg      = {'#181a26', 241, 'foldbg'}
local gray_light  = {'#e0e0e0', 250, 'gray'}
...
local red_darker= {'#800000', 125, 'darkerred'}
...
local green_dark  = {'#30a503', 113, 'darkgreen'}
...
local ice  = {'#40b080', 111, 'cyan'}
local teal = {'#308080', 75,  'blue'}
local kword ={'#6060d0', 76,  'kword'}
...
local highlight_groups = {
	...
	Function = {fg = teal, style='bold'},

	--[[ 4.1.3. Syntax]]
	Statement   = {fg = kword, style='bold'},
	Conditional = {fg = ice, style='bold'},
	Repeat   = {fg = turqoise, style='bold'},
	Label    = {fg = pink, style = 'bold'},
	Operator = {fg = red, style = 'bold'},
	Keyword  = {fg = kword, style='bold'},
	...
	Ignore = {fg = gray},
	Error = {fg = yellow, bg = red, style = 'bold'},
	Todo = {fg = yellow, bg = sign, style = 'bold'},
	Hint = {fg = ice, bg = sign, style = 'italic'},
	Info = {fg = ice, bg = sign, style = 'bold'},
	Warning = {fg = red, bg = black, style = 'bold'},
	...
	debugPC = 'ColorColumn',
	LineNr  = {bg = gutter, fg = gray},
 	QuickFixLine = function(self) return {bg = self.StatusLine.bg} end,
	Visual    = {style = 'inverse'},
	VisualNOS = {bg = gutter},

	--[[ 4.2.4. Popup Menu]]
	Pmenu = {fg = highlight_group_normal.fg},
	PmenuSbar = {bg = gray_darker},
	PmenuSel  = {fg = black, bg = red_darker},
	PmenuThumb = {bg = white},
	WildMenu = 'PmenuSel',

	--[[ 4.2.5. folds]]
	foldcolumn = {bg = foldbg, fg=gray},
	...
	--[[ 4.2.10. Messages]]
	ErrorMsg = {fg = white, style = 'italic'},
	HintMsg  = {fg = white, style = 'italic'},
	InfoMsg  = {fg = pink_light, style = 'italic'},
	ModeMsg  = {fg = yellow},
	WarningMsg = {fg = white, style = 'italic'},
