...
augroup filetypes
  ...
  autocmd FileType vim,nim,python,markdown,tex,lua,json,html,css,dart,go,org,telekasten setlocal tabstop=2 | setlocal shiftwidth=2 | setlocal expandtab | setlocal softtabstop=2 | setlocal fo-=c
