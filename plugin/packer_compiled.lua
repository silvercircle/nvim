...
_G.packer_plugins = {
  ...
  ["noice.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/noice.nvim",
  ...
  ["scratch.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/scratch.vim",
  ...
  ["telescope-coc.nvim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/telescope-coc.nvim",
