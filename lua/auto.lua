  ...
  callback = function(args)
    ...
    if in_pattern(Tweaks.ft_patterns.spell, args.match) then
      if vim.bo.modifiable == true then
        vim.cmd("setlocal tabstop=2 | setlocal shiftwidth=2 | setlocal expandtab | setlocal softtabstop=2 | setlocal textwidth=120 | setlocal ff=unix | setlocal fo+=nwqtc | setlocal foldmethod=manual")
      end
