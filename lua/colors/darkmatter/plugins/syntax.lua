...
local function _set()
  ...
  c.hl("htmlH1", c.localtheme.blue, c.NONE, conf.attrib.bold)
  c.hl("htmlH2", c.localtheme.orange, c.NONE, conf.attrib.bold)
  c.hl("htmlH3", c.localtheme.yellow, c.NONE, conf.attrib.bold)
  c.hl("htmlH4", c.localtheme.green, c.NONE, conf.attrib.bold)
  c.hl("htmlH5", c.localtheme.blue, c.NONE, conf.attrib.bold)
  c.hl("htmlH6", c.localtheme.lpurple, c.NONE, conf.attrib.bold)
  ...
  c.link("luaIn", "Red")
    -- syn_begin: help
  c.hl("helpNote", c.localtheme.lpurple, c.NONE, conf.attrib.bold)
  c.hl("helpHeadline", c.localtheme.red, c.NONE, conf.attrib.bold)
  c.hl("helpHeader", c.localtheme.orange, c.NONE, conf.attrib.bold)
  c.hl("helpURL", c.localtheme.green, c.NONE, { underline = true })
  c.hl("helpHyperTextEntry", c.localtheme.blue, c.NONE, conf.attrib.bold)
