...
function M.palette(desaturate, dlevel, variant)
  if desaturate == true then
    return {
      orange = (dlevel == 1) and { "#ab6a6c", 215 } or { "#9b7a7c", 215 },
      blue = { "#5a6acf", 239 },
      purple = (dlevel == 1) and { "#b070b0", 241 } or { "#a070a0", 241 },
      teal = (dlevel == 1) and { "#609090", 238 } or { "#709090", 238 },
      ...
      yellow = (dlevel == 1) and { "#aaaa60", 231 } or { "#909870", 231 },
      green = (dlevel == 1) and { "#60906f", 231 } or { "#658075", 231 },
      darkyellow = (dlevel == 1) and { "#958434", 180 } or { "#877634" },
      grey = { "#707069", 2 },
      grey_dim = { "#595f6f", 240 },
      diff_red = { "#45292d", 52 },
