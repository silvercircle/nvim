...
local function _set()
  ...
  c.link("NeoTreeNormal", "NvimTreeNormal")
  c.link("NeoTreeNormalNC", "NvimTreeNormal")
  c.hl_with_defaults("NvimTreeEndOfBuffer", c.P.treebg, c.P.treebg)
  ...
  c.link("NeoTreeDimText", "SymbolsOutlineConnector")
  ...
  c.link("NvimTreeSymlink", "Emphasis")
  c.link("NvimTreeImageFile", "Fg")
  c.link("NvimTreeMarkdownFile", "Fg")
  c.link("NvimTreeIndentMarker", "SymbolsOutlineConnector")
  c.link("NvimTreeFolderArrowOpen", "Operator")
  c.link("NvimTreeFolderArrowClosed", "Operator")
  ...
  c.link("NeoTreeFilenameOpened", "NvimTreeOpenedFile")
  ...
  c.hl_with_defaults("CmpPmenu", c.P.fg, c.P.treebg)
  c.hl_with_defaults("CmpPmenuBorder", c.P.grey_dim, c.P.treebg)
  ...
  c.link("BlinkCmpDocCursorLine", "CursorLineNC")
  ...
  vim.api.nvim_set_hl(0, "NavicIconsString",        {bg = c.P.accent[1], fg = c.P.styled.string[1]})
  ...
  c.hl("htmlH1", c.P.styled.h1, c.NONE, conf.attrib.headings)
  c.hl("htmlH2", c.P.styled.h2, c.NONE, conf.attrib.headings)
  c.hl("htmlH3", c.P.styled.h3, c.NONE, conf.attrib.headings)
  c.hl("htmlH4", c.P.styled.h4, c.NONE, conf.attrib.headings)
  c.hl("htmlH5", c.P.styled.h5, c.NONE, conf.attrib.headings)
  c.hl("htmlH6", c.P.styled.h6, c.NONE, conf.attrib.headings)
  c.link("htmlLink", "URL")
