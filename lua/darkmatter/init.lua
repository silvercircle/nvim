...
local function set_all()
  ...
  M.hl_with_defaults("nCursor", M.NONE, M.P.fg)
  M.hl_with_defaults("iCursor", M.NONE, M.P.yellow)
  M.hl_with_defaults("vCursor", M.NONE, M.P.red)
  ...
  M.hl_with_defaults("LuaLine", M.P.fg, M.P.statuslinebg)
  ...
  M.hl("URL", M.P.styled.url, M.NONE, conf.attrib.uri)
  ...
  M.hl_with_defaults("Spelltext", M.P.styled.spelltext, M.NONE)
  ...
  M.hl("String", M.P.styled.string, M.NONE, conf.attrib.str)
  ...
  M.link("@uri", "URI")
  M.link("@text.uri", "URI")
  M.link("@variable", "Identifier")
  M.link("@variable.builtin", "Builtin")
  M.link("@variable.builtin.scala", "Builtin")
  ...
  M.link("@lsp.type.punctuation", "PunctDelim")
  ...
  M.link("@lsp.type.keyword", "Keyword")
  M.link("@lsp.type.typeParameter", "TypeDefinition")
