...
Tweaks.lsp = {
  ...
  serverconfigs = {
    ["ts_ls"] = { name = "lsp.serverconfig.ts_ls", active = true },
    ["texlab"] = { name = "lsp.serverconfig.texlab", active = true },
    ["tinymist"] = { name = "lsp.serverconfig.tinymist", active = true },
    ["nim_langserver"] = { name = "lsp.serverconfig.nim_langserver", active = false },
    ["bashls"] = { name = "lsp.serverconfig.bashls", active = true },
    ["clangd"] = { name = "lsp.serverconfig.clangd", active = true },
    ["ccls"] = { name = "lsp.serverconfig.ccls", active = false },
    ["ada"] = { name = "lsp.serverconfig.ada", active = false },
    ["emmet_language_server"] = { name = "lsp.serverconfig.emmet_language_server", active = true },
    ["cssls"] = { name = "lsp.serverconfig.cssls", active = true },
    ["html"] = { name = "lsp.serverconfig.html", active = true },
    ["gopls"] = { name = "lsp.serverconfig.gopls", active = true },
    ["vimls"] = { name = "lsp.serverconfig.vimls", active = true },
    ["yamlls"] = { name = "lsp.serverconfig.yamlls", active = true },
    ["marksman"] = { name = "lsp.serverconfig.marksman", active = true },
    ["lemminx"] = { name = "lsp.serverconfig.lemminx", active = true },
    ["taplo"] = { name = "lsp.serverconfig.taplo", active = true },
    ["lua_ls"] = { name = "lsp.serverconfig.lua_ls", active = true },
    ["rust_analyzer"] = { name = "lsp.serverconfig.rust_analyzer", active = false },
    ["groovyls"] = { name = "lsp.serverconfig.groovyls", active = false },
    ["jsonls"] = { name = "lsp.serverconfig.jsonls", active = true },
    ["zls"] = { name = "lsp.serverconfig.zls", active = true },
    ["ctags_lsp"] = { name = "lsp.serverconfig.ctags_lsp", active = false },
    ["basedpyright"] = { name = "lsp.serverconfig.basedpyright", active = true },
    ["phpactor"] = { name = "lsp.serverconfig.phpactor", active = false },
    ["dartls"] = { name = "lsp.serverconfig.dartls", active = false },
    ["hls"] = { name = "lsp.serverconfig.hls", active = false },
  },
